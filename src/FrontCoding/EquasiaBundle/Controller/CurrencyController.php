...
use FrontCoding\EquasiaBundle\Entity\Currency;
use FrontCoding\EquasiaBundle\Form\CurrencyType;
...
class CurrencyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FrontCodingEquasiaBundle:Currency')->findAll();
     ...
     * @Method("POST")
     * @Template("FrontCodingEquasiaBundle:Currency:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FrontCodingEquasiaBundle:Currency')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FrontCodingEquasiaBundle:Currency:edit.html.twig")
     */
