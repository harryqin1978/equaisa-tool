...
class Employee implements UserInterface, \Serializable
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Currency", inversedBy="salary_official_currencys")
     * @ORM\JoinColumn(name="salary_official_currency_id", referencedColumnName="id")
     */
    protected $salary_official_currency;

    /**
     * @ORM\ManyToOne(targetEntity="Currency", inversedBy="salary_unofficial_currencys")
     * @ORM\JoinColumn(name="salary_unofficial_currency_id", referencedColumnName="id")
     */
    protected $salary_unofficial_currency;
     ...
     * @var float
     *
     * @ORM\Column(name="salary_official", type="decimal", nullable=true)
     */
    private $salaryOfficial;

    /**
     * @var float
     *
     * @ORM\Column(name="salary_unofficial", type="decimal", nullable=true)
     */
    private $salaryUnofficial;

    /**
     * @var integer
     *
     * @ORM\Column(name="salary_official_currency_id", type="integer", nullable=false)
     */
    private $salaryOfficialCurrencyId;

    /**
     * @var integer
     *
     * @ORM\Column(name="salary_unofficial_currency_id", type="integer", nullable=false)
     */
    private $salaryUnofficialCurrencyId;

    /**
     * @var string
     *
     * @ORM\Column(name="salary_notes", type="text", nullable=true)
     */
    private $salaryNotes;
     ...
     * @var string
     *
     * @ORM\Column(name="bank_name_language_1", type="string", length=255, nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="bank_name_language_2", type="string", length=255, nullable=true)
     */
     ...
     * Set salaryOfficial
     *
     * @param float $salaryOfficial
     * @return Employee
     */
    public function setSalaryOfficial($salaryOfficial)
    {
     ...
     * @return float 
     */
    public function getSalaryOfficial()
    {
        return $this->salaryOfficial;
    }

    /**
     * Set salaryUnofficial
     *
     * @param float $salaryUnofficial
     * @return Employee
     */
    public function setSalaryUnofficial($salaryUnofficial)
    {
        $this->salaryUnofficial = $salaryUnofficial;
    
        return $this;
    }

    /**
     * Get salaryUnofficial
     *
     * @return float 
     */
    public function getSalaryUnofficial()
    {
        return $this->salaryUnofficial;
    }

    /**
     * Set salaryOfficialCurrencyId
     *
     * @param integer $salaryOfficialCurrencyId
     * @return Employee
     */
    public function setSalaryOfficialCurrencyId($salaryOfficialCurrencyId)
    {
        $this->salaryOfficialCurrencyId = $salaryOfficialCurrencyId;
    
        return $this;
    }

    /**
     * Get salaryOfficialCurrencyId
     *
     * @return integer 
     */
    public function getSalaryOfficialCurrencyId()
    {
        return $this->salaryOfficialCurrencyId;
    }

    /**
     * Set salaryUnofficialCurrencyId
     *
     * @param integer $salaryUnofficialCurrencyId
     * @return Employee
     */
    public function setSalaryUnofficialCurrencyId($salaryUnofficialCurrencyId)
    {
        $this->salaryUnofficialCurrencyId = $salaryUnofficialCurrencyId;
    
        return $this;
    }

    /**
     * Get salaryUnofficialCurrencyId
     *
     * @return integer 
     */
    public function getSalaryUnofficialCurrencyId()
    {
        return $this->salaryUnofficialCurrencyId;
    }

    /**
     * Set salaryNotes
     *
     * @param string $salaryNotes
     * @return Employee
     */
    public function setSalaryNotes($salaryNotes)
    {
    ...
    /**
     * Set salary_official_currency
     *
     * @param \FrontCoding\EquasiaBundle\Entity\Currency $salaryOfficialCurrency
     * @return Employee
     */
    public function setSalaryOfficialCurrency(\FrontCoding\EquasiaBundle\Entity\Currency $salaryOfficialCurrency = null)
    {
        $this->salary_official_currency = $salaryOfficialCurrency;
    
        return $this;
    }

    /**
     * Get salary_official_currency
     *
     * @return \FrontCoding\EquasiaBundle\Entity\Currency 
     */
    public function getSalaryOfficialCurrency()
    {
        return $this->salary_official_currency;
    }

    /**
     * Set salary_unofficial_currency
     *
     * @param \FrontCoding\EquasiaBundle\Entity\Currency $salaryUnofficialCurrency
     * @return Employee
     */
    public function setSalaryUnofficialCurrency(\FrontCoding\EquasiaBundle\Entity\Currency $salaryUnofficialCurrency = null)
    {
        $this->salary_unofficial_currency = $salaryUnofficialCurrency;
    
        return $this;
    }

    /**
     * Get salary_unofficial_currency
     *
     * @return \FrontCoding\EquasiaBundle\Entity\Currency 
     */
    public function getSalaryUnofficialCurrency()
    {
        return $this->salary_unofficial_currency;
    }
}